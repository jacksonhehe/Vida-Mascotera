...
export const navigationItems: NavItem[] = [
  ...
  { label: 'Guías de compra', path: '/accesorios', category: 'accesorios', description: 'Selecciones y comparativas para elegir mejor antes de comprar.' },
...
> = {
  ...
  accesorios: {
    title: 'Guías de compra para elegir con más criterio',
    intro: 'Recomendaciones, selecciones y comparativas para paseo, descanso, comida y hogar, con foco en utilidad real.',
    emphasis: 'Contenido pensado para ayudarte a comprar mejor, no a comprar más.',
  },
  comparativas: {
...
export const featuredCategories: CategoryHighlight[] = [
  ...
  },
  {
    ...
    description: 'Comparativas simples para elegir formatos, rutinas y productos que sí aportan valor.',
    path: '/alimentacion',
    accent: 'cream',
